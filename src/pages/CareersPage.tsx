  ...
  const jobs = [
    {
      ...
      department: 'Pre-Primary Section (Nursery, LKG & UKG)',
      type: 'Full Time',
      location: 'Ongole',
      qualifications: [
        'Diploma/Degree in Early Childhood Education',
        'Minimum 2 years experience with pre-primary children',
        'Excellent communication and nurturing skills',
        'Patience and ability to handle young children'
      ],
      responsibilities: [
        'Create a nurturing environment for young learners',
        'Implement age-appropriate activities and games',
        'Monitor child development and maintain progress reports',
        'Communicate effectively with parents about child progress'
      ]
    },
    {
      id: 'social-teacher',
      ...
      location: 'Ongole',
      qualifications: [
        'Bachelor\'s/Master\'s degree in Social Studies/History',
        'B.Ed. with relevant specialization',
        'Minimum 2 years of teaching experience',
        'Strong knowledge of Indian and World History'
      ],
      responsibilities: [
        'Develop engaging social studies curriculum',
        'Conduct interactive history and civics lessons',
        'Organize educational field trips and activities',
        'Prepare students for examinations and assessments'
      ]
    },
    {
      id: 'pet-teacher',
      ...
      qualifications: [
        ...
        'Sports coaching certifications preferred',
    ...
    },
    {
      ...
      responsibilities: [
        'Manage school accounts and financial records',
        'Process fee collections and payments',
        'Prepare monthly financial reports',
        'Handle salary processing and vendor payments',
        'Ensure tax compliance and audits'
      ]
    },
    {
      id: 'front-office',
      ...
      qualifications: [
        ...
        'Minimum 2 years experience in front office management',
        'Proficiency in MS Office'
      ],
      responsibilities: [
        'Handle visitor inquiries and admissions',
        'Manage school communication and correspondence',
